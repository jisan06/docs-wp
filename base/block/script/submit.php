...
class BlockScriptSubmit extends Base\BlockScriptExternal
{
    public function __construct(Library\ObjectConfig $config)
    {
        parent::__construct($config);

        $this->setPath('base/resources/assets/js/block/submit.js');
    }
    ...
    public function beforeEnqueue()
    {
        ...
        $this->getObject('translator')->load('com:easydoc');
