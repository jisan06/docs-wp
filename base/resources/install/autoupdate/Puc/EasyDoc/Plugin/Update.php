<?php
if ( !class_exists('Puc_easydoc_Plugin_Update', false) ):
	 ...
	 * @access public
	 */
	class Puc_easydoc_Plugin_Update extends Puc_easydoc_Update {
		public $id = 0;
		public $homepage;
		...
		public static function fromJson($json){
			...
			$pluginInfo = Puc_easydoc_Plugin_Info::fromJson($json);
			if ( $pluginInfo !== null ) {
		 ...
		 *
		 * @param Puc_easydoc_Plugin_Info $info
		 * @return Puc_easydoc_Plugin_Update
		 */
		 ...
		 *
		 * @param StdClass|Puc_easydoc_Plugin_Info|Puc_easydoc_Plugin_Update $object The source object.
		 * @return Puc_easydoc_Plugin_Update The new copy.
		 */
