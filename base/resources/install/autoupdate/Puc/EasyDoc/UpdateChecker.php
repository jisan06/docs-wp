...
if ( !class_exists('Puc_easydoc_UpdateChecker', false) ):

	abstract class Puc_easydoc_UpdateChecker {
		...
		/**
		 * @var Puc_easydoc_Scheduler
		 */
		public $scheduler;

		/**
		 * @var Puc_easydoc_UpgraderStatus
		 */
		protected $upgraderStatus;

		/**
		 * @var Puc_easydoc_StateStore
		 */
		...
		public function __construct($metadataUrl, $directoryName, $slug = null, $checkPeriod = 12, $optionName = '') {
			...
			$this->upgraderStatus = new Puc_easydoc_UpgraderStatus();
			$this->updateState = new Puc_easydoc_StateStore($this->optionName);
		 ...
		 *
		 * @return Puc_easydoc_Update|null
		 */
		 ...
		 *
		 * @return Puc_easydoc_Update An instance of Update, or NULL when no updates are available.
		 */
		 ...
		 * @return array [Puc_easydoc_Metadata|null, array|WP_Error] A metadata instance and the value returned by wp_remote_get().
		 */
		...
		protected function createDebugBarExtension() {
			// return new Puc_easydoc_DebugBar_Extension($this); 
		}

		/**
		 * Display additional configuration details in the Debug Bar panel.
		 *
		 * @param Puc_easydoc_DebugBar_Panel $panel
		 */
