<?php
if ( !class_exists('Puc_easydoc_Scheduler', false) ):

	/**
	 * The scheduler decides when and how often to check for updates.
	 * It calls @see Puc_easydoc_UpdateChecker::checkForUpdates() to perform the actual checks.
	 */
	class Puc_easydoc_Scheduler {
		 ...
		 *
		 * @param Puc_easydoc_UpdateChecker $updateChecker
