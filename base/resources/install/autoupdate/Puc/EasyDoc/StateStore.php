...
if ( !class_exists('Puc_easydoc_StateStore', false) ):

	class Puc_easydoc_StateStore {
		/**
		...
		/**
		 * @var Puc_easydoc_Update|null Cached update.
		 */
		...
		/**
		 * @return null|Puc_easydoc_Update
		 */
		 ...
		 * @return $this
		 */
		public function setUpdate(Puc_easydoc_Update $update = null) {
			$this->lazyLoad();
			$this->update = $update;
			return $this;
		}
		...
		public function save() {
			...
			if ( isset($this->update)) {
				...
				if ( Puc_easydoc_Utils::startsWith($updateClass, $prefix) ) {
		...
		protected function load() {
			...
			$this->lastCheck = intval(Puc_easydoc_Utils::get($state, 'lastCheck', 0));
			$this->checkedVersion = Puc_easydoc_Utils::get($state, 'checkedVersion', '');
			$this->update = null;
