...
kQuery(function($) {
    ...
    EasyDoc.BatchForm = Koowa.Class.extend({
        batch_form: null,
        ...
        initialize: function(options) {
            ...
            this.humanize_titles = !!parseInt($(this.options.automatic_humanized_titles_selector).val());

            this.category_selector = this.batch_form.find('select[name="easydoc_category_id"]');
            ...
            this.uploader.on('uploader:uploaded', function(event, data) {
                ...
                if (file.status === plupload.DONE && typeof data.result.response !== 'undefined') {
                    ...
                    if (remaining === 0) {
                        ...
                        self.save_button.prop("disabled", false);
                    }
                }
            });
                        ...
                        chain.unshift(function() {
                            ...
                            $.ajax({
                                ...
                                if (xhr.status == 201) {
                                    ...
                                    var item = response.data.attributes,
                                        link = response.data.links.self.replace(/&amp;/g, '&'),
