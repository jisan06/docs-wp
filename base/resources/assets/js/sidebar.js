...
(function($){
     ...
     * @constructor
     */
    EasyDoc.Sidebar = function(options){
    ...
    EasyDoc.Sidebar.prototype = {

        /**
         * @constructs EasyDocs.Sidebar
         */
        constructor: EasyDoc.Sidebar,
        ...
        getDefaults: function(){
            ...
            /** @lends EasyDocs.Sidebar.options */
            var defaults = {
                minHeight: 200,
                sidebar: '.sidebar',
            ...
            if($('.navbar').length) {
                /**
                 * @lends EasyDocs.Sidebar.options.offset.callback
                 * @this EasyDocs.Sidebar
                 */
        ...
        makeCollapsible: function() {
            ...
            sidebar.find('h3').each(function(i, h3){
                var $h3 = $(h3), key = ' EasyDocs #documents-sidebar['+i+']', state = storage[key] != 'closed' ? 'open' : 'closed', panel = $h3.next();
