...
(function(wp, editor, blockEditor, components, blocks, global)
{
    document.addEventListener("DOMContentLoaded", function()
    {
            ...
            return [
                el(
                    ...
                    el(components.PanelBody, {
                        ...
                        EasyDoc.Block.getControl('category', config.attributes.category, props),
                    ...
                    el(components.PanelBody, {
                        ...
                        EasyDoc.Block.getControl('show_action_buttons', config.attributes.show_action_buttons, props),
						EasyDoc.Block.getControl('show_pagination', config.attributes.show_pagination, props),
        ...
        global.EasyDoc.Block.setNodeHandler('.flat_layout_selector', function(node) {
			EasyDoc.Block.addHandler({values: ['list', 'table', 'gallery'], element: node.find('select'), handler: 'selectVisibility'});
        });

		global.EasyDoc.Block.setNodeHandler('.show_pagination_control', function(node) {
			EasyDoc.Block.addHandler({selector: '.k-visibility_pagination__show', attribute: 'show_pagination', element: node.find('input'), handler: 'toggleVisibility'});
        });
    });
