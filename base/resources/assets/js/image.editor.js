...
kQuery(function($) {
    ...
    EasyDoc.ImageEditorFactory = {
        getEditor: function(type, options) {
            return new EasyDoc.ImageEditor(options);
        }
    };

    EasyDoc.ImageEditor = Koowa.Class.extend({
        loadedFile: {},
        getOptions: function() {
            return {
                site: null,
                baseUrl: null,
                editorUrl: 'https://connect.system.ait-themes.club/image-editor/',
                connectToken: null,
