 ...
 * @package EasyDocLabs\Library\Model\Behavior
 */
class ModelBehaviorSearchable extends ModelBehaviorAbstract
{
    ...
    public function __construct(ObjectConfig $config)
    {
        ...
        $columns = (array) ObjectConfig::unbox($config->columns);
    ...
    protected function _getConditions($search, ModelContextInterface $context)
    {
        $state = $context->state;
