...
class DatabaseDriverPdo extends DatabaseDriverAbstract
{
    ...
    public function connect()
    {
        ...
        try {
            ...
            throw new DatabaseException('Connect failed: (' . $exception->getCode() . ') ' . $exception->getMessage(), $exception->getCode(), $exception);
        }
    ...
    public function execute($query, $mode = Database::RESULT_STORE)
    {
        ...
        try {
            ...
            throw new DatabaseException($e->getMessage() . ' of the following query : ' . $query, null, $e);
        }
    }
