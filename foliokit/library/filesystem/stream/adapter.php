 ...
 * are created by PHP itself and therefore are unknown to Foliokit object manager.
 *
 * @author  Johan Janssens <https://github.com/johanjanssens>
 * @package EasyDocLabs\Library\Filesystem\Stream
 */
final class FilesystemStreamAdapter
{
    ...
    public function createStream($url, $mode, $trigger_error = false)
    {
        try
        {
            $this->__stream = \Foliokit::getObject('filesystem.stream.factory')
