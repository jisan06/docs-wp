 ...
 */
class DispatcherRouterResolverRegex  extends DispatcherRouterResolverAbstract
{
    /**
     * Static routes
     *
    ...
    {
        foreach((array)Library\ObjectConfig::unbox($routes) as $path => $routes)
        {
     ...
     * @return bool
     */
    public function resolve(DispatcherRouterRouteInterface $route, $parameters = [])
    {
        $result = false;
        ...
        return $result !== false ? parent::resolve($route, $parameters = []) : false;
    }
     ...
     *
     * @param string $regex The route regex You can use multiple pre-set regex filters, like [digit:id]
     * @param DispatcherRouterRouteInterface $route The route to parse
     * @return bool
     */
    protected function _parseRoute($regex, DispatcherRouterRouteInterface $route)
    {
        $result = false;
     ...
     *
     * @param string $regex The route regex You can use multiple pre-set regex filters, like [digit:id]
     * @param DispatcherRouterRouteInterface $route The route to build
     * @return void
     */
    protected function _buildRoute($regex, DispatcherRouterRouteInterface $route)
    {
        $regex = ltrim($regex, '/');
