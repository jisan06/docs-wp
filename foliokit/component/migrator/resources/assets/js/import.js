...
$(function() {
    var uploader = new plupload.Uploader({
            ...
            max_file_size : Ait Theme ClubMigrator.max_file_size+'b',
            url: Ait Theme ClubMigrator.base_url,
        ...
        processQueue = function(queue) {
            ...
            if (queue.length)
            {
                ...
                var url = Ait Theme ClubMigrator.base_url+'&extension='+extension+'&job='+job;
