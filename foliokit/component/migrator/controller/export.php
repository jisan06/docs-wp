...
class ControllerExport extends ControllerMigrator
{
    protected function _initialize(Library\ObjectConfig $config)
    {
        $config->append(array(
            'folder'    => \EasyDocLabs\WP::get_temp_dir().'/migrator_export',
            'exporters' => array()
        ));
    ...
    protected function _actionCleanup(Library\ControllerContextInterface $context)
    {
        $folder = $this->getTemporaryFolder();
    ...
    protected function _actionRun(Library\ControllerContextInterface $context)
    {
        ...
        /** @var MigratorExportAbstract $exporter */
        ...
        if ($exporter->hasJob($job))
        {
            ...
            return $exporter->getResponse()->getContent();
        }
        else {
    ...
    protected function _actionPackage(Library\ControllerContextInterface $context)
    {
        $wp_version = \EasyDocLabs\WP::global('wp_version');
