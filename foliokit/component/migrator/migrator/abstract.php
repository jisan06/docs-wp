 ...
 */
abstract class MigratorAbstract extends Library\ControllerAbstract implements MigratorInterface
{
    /**
     * A list of jobs.
     *
     * @var Library\ObjectArray
     */
    protected $_jobs;
     ...
     * @return int
     */
    protected function _actionRun(MigratorContext $context)
    {
        $context->result = null;
        $job     = $context->param;
        ...
        if ($job && $this->hasJob($job))
        {
            ...
            $response = new Library\ObjectConfigJson(array('result' => Library\ObjectConfig::unbox($context->result)));
