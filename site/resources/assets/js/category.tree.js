 ...
 * And it changes the default styling and behavior to match the general EasyDocs GUI.
 *
...
var EasyDoc= EasyDoc|| {};
if(!EasyDoc.hasOwnProperty('Tree')) EasyDoc.Tree = {};

(function($){

    EasyDoc.Tree.CategoriesSite = Koowa.Tree.extend({
        ...
        attachHandlers: function(){
            ...
            this._attachHandlers(); // Attach needed events from EasyDocs.Tree.Categories._attachHandlers
