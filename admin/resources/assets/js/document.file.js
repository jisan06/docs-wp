    ...
    $(function() {
        ...
        EasyDoc.File = Vue.extend({
            ...
            mounted: function () {
                ...
                EasyDoc.onSelectFile = function(selected) {
                ...
                $('.easydoc-uploader').on('uploader:uploaded', function(event, data) {
                ...
                $('.k-js-form-controller').on('k:beforeApply', beforeSend)
                    ...
                    .on('k:validate', function(args) {
                        ...
                        if (vm.isLocal) {
                            var uploader = $('.easydoc-uploader').uploader('instance').getUploader();
            ...
            methods: {
                editImage: function() {
                    if (this.isEditable) {
                        imageEditor.loadImage('easydoc-files://'+this.editableFile);
                    }
                },
                updateSelectedFile: function() {
                    if (this.selected_file) {
                        var size = this.entity.size;
                        var uploader = $('.easydoc-uploader').uploader('instance');
