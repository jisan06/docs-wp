    ...
    <div class="k-ui-namespace k-small-inline-modal-holder mfp-hide">
        <div class="k-inline-modal">
            <div class="k-content-block preview extension-[%=metadata.extension%]">
                [%
                var url = Files.app.createRoute({option: 'com_easydoc', view: 'file', format: 'html', folder: folder, name: name});
                %]
            ...
            <ul>
                ...
                <li>
                    ...
                    <?= translate('in')?> <a class="category-link" href="#" data-category="[%=document.easydoc_category_id%]"><em>[%=document.category_title%]</em></a>
                </li>
                [% } %]
            </ul>
            [% } %]
